...
class AgentState(TypedDict, total=False):
    ...
    Fields without a reducer are overwritten on each update (latest value wins).
    Audit-style fields use the `add` reducer so every node contribution is preserved.
    """
    ...
    # Overwritten control fields used by nodes and conditional edges.
    evaluation_result: str  # "success" | "needs_retry" — drives route_after_evaluate
    pending_question: str | None  # clarification question for missing_info routes
